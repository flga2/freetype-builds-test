...
// #cgo CFLAGS: -I${SRCDIR}/dist/linux_amd64/include -I${SRCDIR}/dist/linux_amd64/include/freetype2 -Werror -Wall -Wextra -Wno-unused-parameter
// #cgo LDFLAGS: -L${SRCDIR}/dist/linux_amd64/lib -lfreetypehb_amd64 -lm
// #include <ft2build.h>
